...
import { ProfileSyncCronService } from '@/infra/profile/profile-sync.job'
...
@Module({
	...
	providers: [IngestRepositoryActivityUseCase, SyncProfileDataUseCase, ProfileSyncCronService],
})
